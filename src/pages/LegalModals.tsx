  ...
  return (
    <>
      ...
      <Modal
        ...
        maxWidth="2xl"
      >
        <div className="space-y-4 text-xs text-[#667085] leading-relaxed">
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">1. Information We Collect</h4>
          <p>
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">2. How We Use Your Data</h4>
          <p>
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">3. Warranty & Serial Registration</h4>
          <p>
            To activate your manufacturer warranty (Amaron, Exide, SF Sonic, etc.), your battery serial number and phone number are registered on the respective brand portal for paperless pan-India claims.
          </p>

          <div className="pt-4 border-t border-[#E5E7EB] flex justify-end">
            <button
              onClick={onClosePrivacy}
              className="px-5 py-2 rounded-xl bg-[#2E8B35] hover:bg-[#1F6B2A] text-white font-bold text-xs"
            >
              Close Policy
            </button>
          </div>
      ...
      >
        <div className="space-y-4 text-xs text-[#667085] leading-relaxed">
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">1. 100% Genuine OEM Product Guarantee</h4>
          <p>
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">2. Manufacturer Warranty Fulfillment</h4>
          <p>
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">3. Old Battery Scrap Buyback & Exchange</h4>
          <p>
          ...
          <h4 className="font-bold text-[#172033] text-sm pt-2">4. Doorstep Installation & Safety Standards</h4>
          <p>
